/**
 * wave-effect.gpu-optimized.js
 * - Ultra Smooth, Responsive, Full Feature, Same UI, Lower RAM/GPU Usage
 * - Aggressive GPU compositing promotion
 ...
 * - API/Behavior: 100% parity with original, UI identical
...
(function(root, factory) {
  ...
  let RIPPLE_FADE_DURATION_AUTO = 520;
  let RIPPLE_FADE_DURATION_MANUAL = 320;
  ...
  function animateRipple(ripple, scale) {
    ripple.style.transform = `scale(${scale}) translate3d(0,0,0) translateZ(0)`;
  ...
  function onPointerDown(e) {
    ...
    scheduleRipple(() => {
      ...
      ripple.style.transform = 'scale(1) translate3d(0,0,0) translateZ(0)';
      ripple.style.backfaceVisibility = 'hidden';
      ripple.style.willChange = 'transform, opacity, filter';
  ...
  // UpgradeElement: use WeakSet + GPU optimization
