...
(function(root, factory) {
  ...
  window.addEventListener('scroll', () => {
    ...
    if (n - lastScrollTime < 40) {
      ...
      window._rapidScrollTimer = setTimeout(() => { isRapidScrolling = false; }, 88);
    }
    lastScrollTime = n;
  }, { passive: true });
  ...
  function getRippleBg(color) {
    ...
    return `radial-gradient(circle, rgba(${defaultC[0]},${defaultC[1]},${defaultC[2]},0.13) 62%, rgba(${defaultC[0]},${defaultC[1]},${defaultC[2]},0.078) 74%, rgba(${defaultC[0]},${defaultC[1]},${defaultC[2]},0.054) 100%)`;
  }
