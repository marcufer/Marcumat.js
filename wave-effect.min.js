 ...
 *
 * Performance adaptations added:
 * - Detect device perf level (high/medium/low) and adapt ripple blur, durations, and maximum concurrent ripples.
 * - Restrict creation of new ripples when too many are active (fade oldest first).
 * - Add root classes so CSS can tune variables for different performance tiers.
 */
(function (root, factory) {
  ...
  const INTERNAL_SPEED_MULTIPLIER = 3.5;
  let RIPPLE_FADE_DURATION_AUTO = 800;
  let RIPPLE_FADE_DURATION_MANUAL = 600;
  ...
  function onPointerDown(e) {
    ...
    const blurDuration = Math.max(60, Math.round(scaledDuration * 0.45));
    ...
    schedule(function () {
      ...
      const boxShadow = (PERF_LEVEL === 'low') ? '0 3px 8px rgba(8,12,20,0.03)' : '0 6px 18px rgba(8, 12, 20, 0.04)';
  ...
  function onKeyDown(e) {
    ...
    schedule(function () {
      ...
      const blurDuration = Math.max(60, Math.round(scaledDuration * 0.4));
