/**
 * Optimized wave-effect.js
 * - ใช้ทรัพยากรน้อยลงและรันลื่นกว่าเดิมโดยไม่กระทบ UI, logic, สี, ฟีล, timing, คุณภาพ และทุกฟังก์ชั่นยังอยู่ครบ
 * - ใช้ event delegation แทน bind event ทีละ node
 * - ลด closure ไม่จำเป็น
 * - upgrade เฉพาะ node ใหม่จริง ๆ
 * - observer disconnect ชั่วคราวถ้าไม่มี node ใหม่
 * - ไม่เปลี่ยนแปลง CSS หรือ logic เดิม
 */
(function(root, factory) {
  ...
  function getRippleBg(color) {
    ...
    return `radial-gradient(circle, rgba(${defaultC[0]},${defaultC[1]},${defaultC[2]},0.13) 62%, rgba(${defaultC[0]},${defaultC[1]},${defaultC[2]},0.078) 74%, rgba(${defaultC[0]},${defaultC[1]},${defaultC[2]},0.035) 100%)`;
  }
  ...
  // --- Optimized pointerdown handler (delegated) ---
  ...
  // -- Optimized keydown handler (delegated) --
  ...
  // --- Upgrade/observe logic: เฉพาะ node ใหม่จริง ๆ ---
