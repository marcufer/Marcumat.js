/**
 * wave-effect.ultra-lite.v6.js (with delegate/anti-bubble support and correct fade)
 * Further lightweight optimizations while preserving API, UX and behavior.
 * Now supports: parent with wave-delegate="[selector]" to trigger ripple on child,
 * and ensures delegated ripple fades out like a real touch.
 */
(function (root, factory) {
  ...
  let RIPPLE_FADE_DURATION_AUTO = 600;
  let RIPPLE_FADE_DURATION_MANUAL = 400;
