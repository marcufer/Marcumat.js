...
(function(root, factory) {
  ...
  let RIPPLE_FADE_DURATION_AUTO = 900;   // ผู้ใช้แตะแล้วยกออกทันที (auto-fade)
  let RIPPLE_FADE_DURATION_MANUAL = 500; // ผู้ใช้แตะค้างจน animation จบ แล้วยกนิ้วออก (manual-fade)
