 ...
 * @version 2.3.2
 * (improved: ripple is now removed precisely after fade animation finishes)
 */
...
(function(root, factory) {
  ...
  function clearRipples(el) {
    ...
    ripples.forEach(r => {
      ...
      // Wait for fade transition to finish before removing
      let removed = false;
  ...
  function onPointerDown(e) {
    ...
    // เพิ่มการจดจำเวลาและสถานะขยายจบ
    ...
    function endRipple(){
      const now = performance.now();
      // เฉพาะกรณีวางนิ้วค้างจน ripple ขยายจบแล้วจึงยกนิ้ว
      if (animationEnded || (now - rippleCreatedAt) >= duration - 10) {
        ripple.style.setProperty('--ripple-fade-duration', '800ms'); // จางหายเร็วขึ้น
      }
      ripple.classList.add('fading');
      // รอ transitionend ของ opacity ก่อนค่อย remove
      let removed = false;
