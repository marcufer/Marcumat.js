/**
 * wave-effect.gpu.min.js (GPU-accelerated, minimal CPU, full feature parity, UI logic unchanged)
 * - Uses transform: translate3d/scale for GPU compositing
 * - Will-change, backface-visibility, minimal layout/paint
 * - All event logic, pooling, scroll/touch prevention, and settings as original
 * - No change to public API or behavior
 * - For use with wave-effect.min.css (optimally GPU-tuned)
 */
...
(function(root, factory) {
  ...
  // --- Gesture/Scroll Touch Detection
  let lastTouchTime = 0;
  ...
  const SCROLL_VELOCITY_THRESHOLD = 1.7;
  const SCROLL_DISTANCE_THRESHOLD = 18;
  const SCROLL_TIME_WINDOW = 80;
  const FINE_SCROLL_THRESHOLD = 0.43;
