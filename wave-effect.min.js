...
(function(root, factory) {
  ...
  const RIPPLE_HALO_BLUR = 0.6; // ปรับ blur ต่ำลง ลด GPU
  ...
  function querySelectorAllCached(sel) {
    const now = Date.now();
    if (sel === '[wave]' && (now - lastUpgradeAll < 2000) && cachedWaveNodes.length > 0) return cachedWaveNodes;
