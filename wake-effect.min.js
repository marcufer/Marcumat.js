...
(function(root, factory) {
  ...
  function maximalExpandedCoverageRadius(x, y, width, height) {
    ...
    let minRadius = 28;
	// Adjusted to provide a smoother expansion
    return Math.max(maxDist * 0.8 + expand * 0.5, minRadius);
  }
  ...
  function smartDuration(x, y, width, height) {
	...
	// Adjusted duration calculation for smoother animation
    const duration = BASE_DURATION - (BASE_DURATION - MIN_DURATION) * (ratio * MAX_EXTRA * 0.7);
