/**
 * wake-effect.js (Improved 2025)
 * Material Ripple Effect: ใช้ขนาดจริงของ element คำนวณขยาย halo เพื่อให้ ripple ขยายพอดี ไม่ใหญ่เกิน
 * ปรับสูตรสำหรับใช้งานข้ามเว็บ/ข้ามดีไซน์ได้ดีขึ้น
 * @version 2.4.1
 */
(function(root, factory) {
  ...
  function ensureRippleStyles() {
    ...
    const ok = computed.transitionDuration !== '' && 
      (computed.borderRadius === '50%' || computed.borderRadius === '50% 50%');
...
body .ripple.fading, .ripple.fading { opacity:0; }
  ...
  // ปรับสูตร: ใช้ขนาดจริง, ขยายแค่พอดีขอบ element + เผื่อขอบนิดเดียว
  ...
  function onPointerDown(e) {
    ...
    // ใช้ขนาดจริง element คำนวณ scale
    ...
    const cappedScale = Math.min(haloFinalScale, 1.4); // cap ไม่ให้ใหญ่เกิน 1.4 เท่า
  ...
  function onKeyDown(e) {
    ...
    const radius = maximalExpandedCoverageRadius(x, y, rect.width, rect.height);
    const haloFinalScale = (radius * 2) / RIPPLE_HALO_START_DIAMETER;
    const cappedScale = Math.min(haloFinalScale, 1.4);
